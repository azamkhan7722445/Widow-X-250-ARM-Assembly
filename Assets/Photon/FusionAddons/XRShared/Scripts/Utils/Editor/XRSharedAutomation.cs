...
namespace Fusion.XR.Shared.Editor
{
    public static class XRSharedAutomation
    {
        ...
        {
            var runner = GameObject.FindAnyObjectByType<NetworkRunner>();
        ...
        public static bool TryGetHardwareRig(out HardwareRig hardwareRig)
        {
            ...
            {
                var hardwareRigs = GameObject.FindObjectsByType<HardwareRig>(FindObjectsSortMode.None);
        ...
        public static bool TryGetGrabbableObject(out NetworkGrabbable networkGrabbable)
        {
            ...
            {
                var networkGrabbables = GameObject.FindObjectsByType<NetworkGrabbable>(FindObjectsSortMode.None);
        ...
        public static bool TryGetLaunchableObject(out NetworkRigidbody3D networkRigidbody3D)
        {
            ...
            {
                var networkRigidbody3Ds = GameObject.FindObjectsByType<NetworkRigidbody3D>(FindObjectsSortMode.None);
